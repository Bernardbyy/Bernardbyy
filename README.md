...
- 🔭 I've concluded my internship at an eKYC company in the Fintech Industry to prevent against visual presentation attacks.   
...
<ul style="list-style: none; padding: 0;">
    ...
    <li style="margin-top: 10px; font-size: 18px;"><a href="https://github.com/Bernardbyy/RAG" style="color: white;">CelcomDigi Internal Knowledge Assistant (RAG) w/ Qwen0.6B</a></li>
